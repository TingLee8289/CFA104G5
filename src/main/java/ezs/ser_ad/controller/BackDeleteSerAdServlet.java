...
@WebServlet("/ser_ad/BackDeleteSerAdServlet.do")
@MultipartConfig(fileSizeThreshold = 1024 * 1024, maxFileSize = 5 * 1024 * 1024, maxRequestSize = 5 * 5 * 1024 * 1024)
public class BackDeleteSerAdServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("delete".equals(action)) { // 來自listAllEmp.jsp
			...
			try {
				...
				String url = "/backend/ser/serAd/viewSerAd.jsp";
				...
				RequestDispatcher failureView = req.getRequestDispatcher("/backend/ser/serAd/viewSerAd.jsp");
