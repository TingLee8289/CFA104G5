...
//			}
		...
		if ("listRenAppByMEM".equals(action)) { // 來自select_page.jsp的複合查詢請求
			...
			try {
				...
				if(map.containsKey("apt_mem_id")) {
					String[] strs = map.get("apt_mem_id");
