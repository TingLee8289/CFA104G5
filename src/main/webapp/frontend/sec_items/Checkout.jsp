...
<style>
@import
	url(https://fonts.googleapis.com/css?family=Droid+Serif:400,400italic|Montserrat:400,700)
	;
...
.heading a.continue:hover:after, .heading a.continue:focus:after,
